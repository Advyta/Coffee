...
const CardPlaceholder = () => {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 lg:gap-8 mt-5 p-4">
      {Array(4)
        .fill("")
        .map((_, index) => (
          <div key={index} className="justify-self-center">
            <div className="flex flex-col gap-4 lg:gap-8 sm:flex-row bg-card-bg backdrop-blur-sm px-8 py-6 lg:px-14 md:py-9 rounded-3xl max-w-2xl justify-center animate-pulse">
