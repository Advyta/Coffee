export const coffeeJourney: {
  ...
  },
  {
    ...
    text: `Newly planted coffee trees take about 3 to 4 years to produce fruit, known as coffee cherries. These cherries turn a bright red when ripe and ready for harvest. Typically, there's one major harvest each year, but in countries like Colombia, where coffee flowers twice annually, there’s a main and secondary crop.
          ...
          In most coffee-growing regions, harvesting is done by hand, a labor-intensive process. However, in flatter areas like Brazil, where coffee fields are vast, mechanized harvesting is common. There are two main harvesting methods:
            ...
            1. **Strip Picking:** All cherries are stripped from the branch at once, either by hand or machine, without considering ripeness.
  
            2. **Selective Picking:** Only the ripe cherries are carefully picked by hand. This method, though more labor-intensive and costly, is used for high-quality Arabica beans. Skilled pickers rotate through the fields every 8-10 days, choosing only the ripest cherries.
  ...
  },
  {
    ...
    text: `After coffee cherries are harvested, they can be processed in one of three main ways: Washed, Dry (Natural), or Honey.
            ...
            1. **Washed Process:** In the washed method, water is used to cleanly separate the fruit from the bean, highlighting the pure characteristics of the coffee. While this method requires a lot of water, newer techniques are reducing water waste. This process is excellent for appreciating the unique flavors of single-origin coffees.

            2. **Dry (Natural) Process:** The traditional dry method involves drying coffee cherries in the sun before separating the fruit from the bean. Though it’s cost-effective and eco-friendly, it can lead to inconsistent flavors if unripe cherries are mixed in. When done well, this method produces beans with sweet, fruity notes as the beans absorb qualities from the drying cherries.

            3. **Honey Process:** The honey process is a hybrid between the washed and dry methods. It uses water to remove most of the fruit but leaves some sticky mucilage (the “honey”) on the beans, which are then dried in the sun. This method balances the bean's natural flavors with the sweetness of the fruit. It’s popular in regions like Costa Rica and has various subcategories, such as Yellow, Red, and Black Honey, each offering different flavor profiles.
  ...
  },
  {
    ...
    text: `Parchment coffee undergoes several key processing steps:
            ...
            1. **Hulling:** For wet-processed coffee, hulling removes the parchment layer (endocarp) from the beans. In dry processing, hulling removes the entire dried husk, including the exocarp, mesocarp, and endocarp.

            2. **Polishing (Optional):** Polishing removes any remaining silver skin from the beans. While polished beans may look superior, there’s little difference in quality compared to unpolished ones.
            ...
            4. **Defect Removal:** Defective beans—those with flaws like improper size, color, or damage—are removed either by hand or machine. This step ensures that only the highest quality beans make it to market.
